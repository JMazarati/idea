...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <a href="#"><img src="/resources/upload_image/${top5.get(0).pict}" alt="picture" class="thumbnail"/></a>
            <div>
        ...
        <div class="item">
            <a href="#"><img src="/resources/upload_image/${top5.get(1).pict}" alt="picture" class="thumbnail"/></a>
            <div>
        ...
        <div class="item">
            <a href="#"><img src="/resources/upload_image/${top5.get(2).pict}" alt="picture" class="thumbnail"/></a>
            <div>
                <p>
        ...
        <div class="item">
            <a href="#"><img src="/resources/upload_image/${top5.get(3).pict}" alt="picture" class="thumbnail"/></a>
            <div>
                <p>
        ...
        <div class="item">
            <a href="#"><img src="/resources/upload_image/${top5.get(4).pict}" alt="picture" class="thumbnail"/></a>
            <div>
                <p>
