 ...
 */
public class InsertRating extends SqlUpdate{
    private static final String SQL_INSERT="INSERT INTO rating_personal_table(user_creator,idea_link,rating) " +
            "VALUES ((SELECT id FROM user_table WHERE username=:user_creator),:idea_link,:rating)";

    public InsertRating(DataSource dataSource){
