...
public class SelectAllIdea extends MappingSqlQuery<Idea>{
    private static final String SQL_SELECT_ALL_IDEA = "SELECT i.id,i.caption,u.username,i.rating,i.date_create, i.category_link, i.tags FROM user_table u inner join idea_table i on(i.owner=u.id) ORDER BY id";
